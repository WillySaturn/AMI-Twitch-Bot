# ===================================================================================
# A.M.I. - WillySaturn's Interactive Twitch Bot (v77)
# ===================================================================================
# This version externalizes all moderation wordlists into separate .txt files
# within a 'mod_lists' directory for improved safety, privacy, and maintainability.
# ===================================================================================
...
def trigger_lightning_flash(username):
    """Sends OBS commands to show and hide a source for a flash effect."""
    global last_lightning_flash
    if time.time() - last_lightning_flash < 30 and username.lower() != CHANNEL.lower():
        return
